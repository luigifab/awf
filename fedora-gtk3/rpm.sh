#!/bin/bash
# debian: sudo apt install dpkg-dev devscripts build-essential dh-make dh-autoreconf intltool libgtk-3-dev rpm
# fedora: sudo dnf install rpmdevtools rpm-sign autoconf automake gtk3-devel
